...
const Contacts = () => {
    ...
    const myStyle = {
        color: 'rgb(10, 0, 0)',
        // Add other style properties as needed, for example:
    ...
    return (
        <div className="justify-center pt-16 text-gray-50   p-4  w-full ">
            <div className="m-4">
                <button className=" bg-violet-600 p-2 text-2xl">
      ...
      <svg
        ...
        stroke-width="1.5"
      >
        <path d="m10.25 5.75-4.5 4.5m0-4.5 4.5 4.5" fill="#0a0000"></path>
        <circle cx="8" cy="8" r="6.25"></circle>
      </svg>

      <h1 className="text-3xl ml-4 text-black">
        No Contact Found. Please add a contact from
        <br />
